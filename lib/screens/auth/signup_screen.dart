...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signupAdmin() async {
    ...
    if (name.isEmpty ||
        ...
        adminSecret.isEmpty) {
      _showMessage(
        AppLocalizations.of(context).translate('fillAllFieldsAdminSecret'),
      );
      return;
    }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(loc.translate('fullName'), controller: _nameController),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: InputDecoration(
                hintText: loc.translate('selectCountry'),
                filled: true,
            ...
            // 🔹 Pass the hide flag and a toggle callback
            _buildTextField(
              loc.translate('password'),
            ...
            _buildTextField(
              loc.translate('adminSecretHint'),
              controller: _adminSecretController,
              isPassword: true,
              obscureText: _hideAdminSecret,
              onToggleVisibility: () {
                setState(() => _hideAdminSecret = !_hideAdminSecret);
              },
            ),
            ...
            Row(
              ...
              children: [
                Text(loc.translate('alreadyHaveAccount')),
                GestureDetector(
